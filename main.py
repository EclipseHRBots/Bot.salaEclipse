...
from highrise import BaseBot,User,CurrencyItem,Item,Position
...
class Bot(BaseBot):
    ...
    async def on_user_join(self, user: User, position: Position | AnchorPosition) -> None:
        ...
        await self.highrise.send_whisper(user.id,f"𝑩𝒊𝒆𝒏𝒗𝒆𝒏𝒊𝒅𝒐 𝒂 𝑪𝒍𝒖𝒃 𝑪𝒂𝒔𝒆𝒓𝒊́𝒐🏠 𝑬𝒔𝒑𝒆𝒓𝒐 𝒒𝒖𝒆 𝒅𝒊𝒔𝒇𝒓𝒖𝒕𝒆 𝒅𝒆 𝒍𝒂 𝒎𝒆𝒋𝒐𝒓𝒆𝒔 𝒄𝒂𝒏𝒄𝒊𝒐𝒏𝒆𝒔 𝒅𝒆 𝒍𝒂 𝒔𝒂𝒍𝒂, 𝑵𝒐 𝒐𝒍𝒗𝒊𝒅𝒆𝒔 𝒊𝒏𝒗𝒊𝒕𝒂𝒓 𝒂 𝒕𝒖𝒔 𝒂𝒎𝒊𝒈𝒐, 𝒄𝒖𝒍𝒊𝒕𝒐, 𝒏𝒐𝒗𝒊𝒂, 𝒏𝒐𝒗𝒊𝒐, 𝑺𝒊𝒈𝒖𝒆𝒏 𝒂 @𝑵𝒆𝒛𝒖𝒙 𝑷𝒂𝒓𝒂 𝒒𝒖𝒆 𝒆𝒔𝒕𝒆́𝒏 𝒑𝒆𝒏𝒅𝒊𝒆𝒏𝒕𝒆 𝒅𝒆 𝒍𝒐 𝒆𝒗𝒆𝒏𝒕𝒐 𝒒𝒖𝒆 𝒔𝒆 𝒗𝒊𝒆𝒏𝒆 𝒚 𝒅𝒆 𝒍𝒂 𝒏𝒐𝒗𝒆𝒅𝒂𝒅𝒆𝒔, 𝑵𝒐 𝒕𝒆 𝒍𝒐 𝒑𝒊𝒆𝒓𝒅𝒂🔥. {user.username} si necesitas ayuda usa !help  ")
                  ...
                  try:
                      for u in users:
                          ...
                          if str((u_give).lower()).strip() == str(name).strip():
                              await self.highrise.teleport(u.id,Position(x=15.5, y=11.25, z=13.0, facing='FrontRight')) 
                              break
                  except:
                      pass
              else:
              ...
              if len(split) == 2:
                  ...
                  try:
                      for u in users:
                          u_give = str("@") + str((u.username).lower())
                          if str((u_give).lower()).strip() == str(name).strip():
                              await self.highrise.teleport(u.id,Position(x=15.5, y=3.25, z=13.0, facing='FrontRight'))
                              break
                  except:
                      pass
              else:
                  await self.highrise.teleport(user.id,Position(x=15.5, y=3.25, z=13.0, facing='FrontRight'))
              ...
              if len(split) == 2:
                  ...
                  try:
                      for u in users:
                          u_give = str("@") + str((u.username).lower())
                          if str((u_give).lower()).strip() == str(name).strip():
                              await self.highrise.teleport(u.id,Position(x=13.0, y=0.0, z=15.5, facing='FrontRight')) 
                              break
                  except:
                      pass
              else:
                  await self.highrise.teleport(user.id,Position(x=13.0, y=0.0, z=15.5, facing='FrontRight'))
...
Item(type='clothing', amount=1, id='bag-n_registrationavatars2023furrytail', account_bound=False, active_palette=-1),
    ...
    async def on_tip(self, sender: User, receiver: User, tip: CurrencyItem | Item) -> None:
        ...
        if receiver.username == "BOTS_ECLIPSE" :
          if tip.amount == 50 :
              await self.highrise.teleport(f"{sender.id}", Position(x=15.5, y=11.25, z=13.0, facing='FrontLeft'))
